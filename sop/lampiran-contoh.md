# Lampiran: Contoh Format Postingan
...
Kutipan dari tokoh bernama dengan atribusi lengkap dan jumlah tagar dalam batas 1–5 *(Requirement R4.6)*.
...
> Catatan verifikasi: sebelum tayang, kutipan tokoh bernama wajib diverifikasi dengan **minimal dua rujukan tepercaya** dan status berubah ke APPROVED *(Requirement R3.1)*. Untuk contoh ini, atribusi "Nelson Mandela" telah dikonfirmasi melalui ≥2 rujukan tepercaya sehingga layak diposting.

## Contoh 2: Kutipan Anonim

Kutipan tanpa tokoh bernama; atribusi tetap **wajib dicantumkan** menggunakan label "Anonim" *(Requirement R3.5)*, dengan jumlah tagar dalam batas 1–5 *(Requirement R4.6)*.
...
## Contoh 3: Kutipan Tradisi/Peradaban

Kutipan yang bersumber dari tradisi atau peradaban; atribusi merujuk nama tradisi tersebut *(Requirement R3.5)*, dengan jumlah tagar dalam batas 1–5 *(Requirement R4.6)*.
