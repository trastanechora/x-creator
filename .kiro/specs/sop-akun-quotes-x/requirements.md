...
11. THE SOP SHALL menetapkan komitmen waktu minimum bagi Founder dan Co-Founder sebagai project sampingan (part-time) dengan ambang default Founder ≥ 7 jam per minggu dan Co-Founder ≥ 5 jam per minggu yang dapat disesuaikan, dan mewajibkan sekurang-kurangnya satu pihak aktif setiap hari untuk menjaga irama posting harian (R9.1) dan moderasi, dan IF salah satu pihak berhalangan karena alasan wajar (sakit atau cuti yang diberitahukan sebelumnya), THEN THE SOP SHALL menetapkan bahwa ketidakhadiran tersebut tidak dihitung sebagai pelanggaran komitmen. (SOP-B.11)
12. THE SOP SHALL menetapkan matriks pembagian peran Founder dan Co-Founder yang mencantumkan penanggung jawab utama dan penanggung jawab cadangan untuk tiap area operasional selaras dengan Matriks Peran & Wewenang (R1, SOP-1.6), dengan keputusan strategis, keamanan, dan persetujuan konten sensitif tetap berada pada Admin_Utama. (SOP-B.12)
13. THE SOP SHALL menetapkan tinjauan kontribusi berkala yang dilakukan bersamaan dengan pelaporan keuangan (R12.9) berbasis data terukur yang mencakup jumlah Quotes, jumlah balasan harian (R6.6), aktivitas moderasi, dan realisasi jam terhadap komitmen (R12.11), serta menyepakati penyesuaian bila terdapat ketimpangan kontribusi. (SOP-B.13)
14. IF salah satu pihak secara berulang tidak memenuhi komitmen waktu (R12.11) atau perannya (R12.12) tanpa alasan wajar, THEN THE SOP SHALL menetapkan tahapan bertingkat berupa klarifikasi, rencana perbaikan berjangka waktu, redistribusi tugas, peninjauan penyesuaian bagi hasil (R12.4) atau Kepemilikan_Ekuitas (R12.2) yang hanya berlaku dengan persetujuan kedua pihak termasuk opsi vesting, hingga exit sesuai tata kelola keluarnya pihak (R12.10), dan THE SOP SHALL menandai penyesuaian bagi hasil, kepemilikan, dan vesting tersebut sebagai to-be-confirmed oleh penasihat hukum. (SOP-B.14)
